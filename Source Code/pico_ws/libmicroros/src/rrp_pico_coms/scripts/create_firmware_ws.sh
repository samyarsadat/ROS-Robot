#!/bin/sh
# Credit to Dr. Jon Durrant (https://github.com/jondurrant/RPIPicoMicroRosServoExp/blob/main/uros_ws/src/ros2_servo/scripts/create_fwws.sh)
# This script was NOT written by me, though I have slightly modified it.
