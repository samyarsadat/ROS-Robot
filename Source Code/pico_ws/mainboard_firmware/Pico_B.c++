...
// ---- Error handler ----
void clean_shutdown(int core, const char * err_msg)
{
    if (core_1_continue)
    {
...
void check_rc(rcl_ret_t rctc)
{
    if (rctc != RCL_RET_OK)
    {
        clean_shutdown(0, "RC Check failed");
    }
}
...
void loop()
{
    ...
    {
        clean_shutdown(0, "Loop timeout exceeded");
    }
}
...
void loop1()
{
    ...
    {
        clean_shutdown(1, "Loop 1 timeout exceeded");
    }
}
...
void init_core_1()
{
    ...
    {
        init_pins();
        clean_shutdown(1, "Core 1 FIFO receive failure");
    }
...
int main() 
{
    ...
    {
        init_pins();
        clean_shutdown(0, "Core 0 FIFO receive failure");
    }
