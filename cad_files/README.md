...
### .SLDPRT & .SLDASM
These files are for people that have access to Solidworks.\
These files are ideal for editing.

<br>

### .STEP
These are editable files that can be opened with almost any CAD software.\
These are for people that want to edit the project but don't have Solidworks.

<br>

### .STL
These are non-editable files used for 3D printing.\
They can be easily imported into all 3D printer slicer software.

<br>

### Robot Description
The `robot_description` directory contains 3D model files prepared for use with ROS.\
They are used for robot visualizations when using RViz or for simulations with Gazebo.

<br>

## Improvements for Re-design
