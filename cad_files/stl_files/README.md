### 3D Printing details:
   ...
   - You can find already split, ready to print `STL` files in the `ready_to_print` folder.
...
#### Quantities:
    ...
    - 1X ready_to_print/Main_Body_Front.stl
    - 1X ready_to_print/Main_Body_Back.stl
    - 1X ready_to_print/Mid_Plate_Front.stl
    - 1X ready_to_print/Mid_Plate_Back.stl
    - 1X Top_Plate_Center_Support_Plate.stl
    - 1X ready_to_print/Top_Plate_Front.stl
    - 1X ready_to_print/Top_Plate_Back.stl
